...
from src.modules.cex.binance.utils.binance_sub_transfer import transfer_from_subaccs_to_main
...
class Binance(CEX):
    ...
    def __str__(self) -> str:
        if self.config.binance_config.withdraw_settings:
            return (
